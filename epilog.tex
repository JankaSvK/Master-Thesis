...
Based on these findings, we have organized the faces from the dataset into a 2D grid with the help of the self-organizing map. We further present a traversal structure to allow quick searching withing the grid. The user is also provided with the option to display all similar faces to a given face.
